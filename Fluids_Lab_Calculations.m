...
[f_t,f_e,Re,V,dp] = solve_friction_factors(SP_Full_SF_high,SP_Full_SF_low,SF,A,L,rho,D_s,mu);
...
[f_t,f_e,Re,V,dp] = solve_friction_factors(SP_Full_MF_high,SP_Full_MF_low,MF_SP,A,L,rho,D_s,mu);
...
f_t = [];
f_e = [];
[f_t,f_e,Re,V,dp] = solve_friction_factors(SP_Up_SF_high,SP_Up_SF_low,SF,A,L,rho,D_s,mu);
...
[f_t,f_e,Re,V,dp] = solve_friction_factors(SP_Up_MF_high,SP_Up_MF_low,MF_SP,A,L,rho,D_s,mu);
...
[f_t,f_e,Re,V,dp] = solve_friction_factors(SP_Dn_SF_high,SP_Dn_SF_low,SF,A,L,rho,D_s,mu);
...
[f_t,f_e,Re,V,dp] = solve_friction_factors(SP_Dn_MF_high,SP_Dn_MF_low,MF_SP,A,L,rho,D_s,mu);
...
[f_t,f_e,Re,V,dp] = solve_friction_factors(LP_MF_high,LP_MF_low,MF_LP,A,L,rho,D_l,mu);
...
[f_t,f_e,Re,V,dp] = solve_friction_factors(LP_LF_high,LP_LF_low,LF,A,L,rho,D_l,mu);


%%% Functions used to solve for parameters needed to sove for friction
%%% factor
function [f_t,f_e,reo,Vo,dpo] = solve_friction_factors(high,low,flow,A,L,rho,D,mu)
f_t = [];
f_e = [];
reo = [];
Vo = [];
